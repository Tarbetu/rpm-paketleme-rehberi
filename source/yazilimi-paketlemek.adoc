...
ifdef::rhel[chroot] 
ortamıdır. Bu ortam, dosya sistemi içerisindeki paketi kuracak tarafın sisteminin kök dizinini temsil eden derleme yapıları dizinine yerleştirir. Yerleştirme düzeni son kullanıcının __Dosya Sistemi Hiyerarşisi__ standartlarına uygun olmalıdır. 
